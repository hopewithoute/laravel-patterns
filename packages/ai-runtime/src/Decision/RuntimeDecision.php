...
namespace Labtime\AiRuntime\Decision;
...
readonly class RuntimeDecision
{
    /**
    ...
    public function __construct(
        ...
        public RuntimeDecisionStatus $status = RuntimeDecisionStatus::Allow,
    ...
    public static function reject(string $reason, AiIntent $intent = AiIntent::OutOfScope, array $metadata = []): self
    {
        return new self(
            ...
            status: RuntimeDecisionStatus::Reject,
    ...
    {
        return $this->status === RuntimeDecisionStatus::Allow;
    }
