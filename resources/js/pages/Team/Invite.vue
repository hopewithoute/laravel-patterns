...
<template>
    ...
    <PageWidth size="content" class="space-y-8">
        ...
        <div class="border-border bg-card space-y-6 rounded-2xl border p-6">
            <!-- Invite Link -->
            <div>
                <label class="text-foreground mb-2 block text-sm font-medium"> Invite Link </label>
                ...
                <p class="text-muted-foreground mt-2 text-sm">
                    Share this link with your team members. They'll be able to create an account and
            ...
            <div class="border-border border-t pt-6">
                <label class="text-foreground mb-2 block text-sm font-medium"> Invite Code </label>
                <div class="flex items-center gap-4">
                    <code class="bg-muted text-foreground rounded-md px-4 py-2 font-mono text-lg">
